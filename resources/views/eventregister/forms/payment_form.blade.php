<form action="/payevent" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue-grey w3-margin">
 ...
 -->
  ...
  <div class="w3-row w3-section">
    ...
    <div class="w3-rest">
      <input class="w3-input w3-border w3-gray" name="name" type="text" value="{{ Auth::user()->name }}"
        placeholder="Name">
    </div>
  </div>
  ...
  <div class="w3-row w3-section">
    <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <div class="w3-input w3-border w3-gray w3-medium">Event Cost: ${{ $event->cost }}</div>
    </div>
  </div>
  ...
  <label>I authorize charging my card on file for the Event registration cost in the amount of
    ${{$event->cost}}.</label><br>
