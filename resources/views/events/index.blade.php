    ...
    <div class="w3-content w3-center w3-panel w3-card">
      ...
      @foreach ($events as $event)
       ...
       <a href="/events/{{$event->id}}" class='w3-row-padding w3-content w3-large' style="solid 2px blue">
          ...
          <h3><b>{{$event->name}}</b> <span class="w3-right w3-tag w3-dark-grey w3-round">New</span></h3>
          <p class="w3-text-grey">{{$event->description}}. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis</p>
          </div>
      </a>
