...
<body>
  ...
  <!--This is in two places BIG Navbar (sit on top) -->
  <!-- BIG Navbar (sit on top) -->
  <!--This is in two placesBIG Navbar (sit on top) -->
  <!-- BIG Navbar (sit on top) -->
    ...
    <div id='menu_items' class="w3-row  w3-opacity w3-hide-small " style='font-size:1.5em;'>
      ...
      <div class="w3-col  s3">
        <button href="#plans" class="w3-button w3-block w3-hover-blue-grey  "
          onclick="openNav('Admissions')">ADMISSIONS</button>
      </div>
      ...
      <div class="w3-col  s3">
        <button href="#contact" class="w3-button w3-block w3-hover-blue-grey"
          onclick="openNav('Parents')">PARENTS</button>
      </div>
  ...
  <div class="w3-row w3-padding-64 w3-content" id="about">
    ...
    <div class="w3-col l6 w3-padding">
      ...
      <p class="text"> Edmonton Islamic Academy students learn, achieve, and grow in an environment that promotes
        Islamic character as modeled by Prophet Mohamed (PBUH) and his companions. The Academy offers a rich learning
        experience fully compliant with the Alberta curriculum. In addition, our students are taught to be engaged and
        responsible Canadian citizens. Our goal is to provide the environment and the tools necessary to fulfill this
        mission.
      </p>
    ...
    <div class="col row1  " style="">
      <div id='staff_des' class="col1  w3-large w3-padding">
        ...
        <h3>Imam Mahmoud Omar</h4>
          <p class='text'>Imam Omar is a specialist in the Fundamentals of Religion (Usul al-Din) with degrees from
            Al-Azhar University (BA) and the Islamic University of Minnesota (MEd, PhD).</p>
  ...
  <div class="bgimg-2 w3-display-container w3-center w3-opacity-min" id="Events">
    <div class="w3-display-middle">
      ...
      <button
        class='w3-button w3-transparent w3-border w3-border-white w3-topbar w3-large w3-text-black w3-white w3-opacity'>Take
        a tour</button>
    </div>
  ...
  <div class='row '>
    <div class="w3-container col m6 w3-padding-32  w3-card-4" style="">
      ...
      <h5>
        EIA students achieve their maximum potential in an environment of intercultural and interfaith understanding and
        respect, and use their leadership skills and intellect for the betterment of humanity</h5>
      <h5>The Edmonton Islamic Academy offers an education of the highest quality, embedded in the values of the Islamic
        faith, to enable students to become
